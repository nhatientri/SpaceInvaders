...
const uint16_t BITMAP_BULLET_ID = 2;
const uint16_t BITMAP_GREEN_ID = 3;
const uint16_t BITMAP_PLAYER_ID = 4;
const uint16_t BITMAP_RED_ID = 5;
const uint16_t BITMAP_YELLOW_ID = 6;
